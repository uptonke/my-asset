...
Generated: `2026-06-17T13:26:21+00:00`
...
|---|---:|---:|---:|---:|---:|---|
| `inverse_vol_baseline` | 12 | 0.0 | 0.0 | 22.888 | 0.0 | `watch_only_validation` |
| `scipy_min_variance_fallback` | 12 | 0.0 | 0.0 | 73.479 | 0.0 | `watch_only_validation` |
